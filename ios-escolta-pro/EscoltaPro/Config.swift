...
enum Config {
    static let EXPO_PUBLIC_FIREBASE_API_KEY = ""
    static let EXPO_PUBLIC_FIREBASE_APP_ID = ""
    static let EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID = ""
    static let EXPO_PUBLIC_FIREBASE_PROJECT_ID = ""
    static let EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET = ""
