...
export const mockGuards: Guard[] = [
  {
    ...
    bio: 'Ex Policia Estatal de Quintana Roo and Ex Ejercito Mexicano Protective Services Division with 12 years of executive protection experience.',
    height: 185,
    weight: 95,
    languages: ['en', 'es'],
    hourlyRate: 150,
  ...
  },
  {
    ...
    bio: 'Ex Ejercito Mexicano Special Forces with extensive close protection and threat assessment experience.',
    height: 190,
    weight: 100,
    languages: ['en', 'fr'],
    hourlyRate: 175,
