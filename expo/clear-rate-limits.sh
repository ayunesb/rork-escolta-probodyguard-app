...
echo "  - client@demo.com: <contrasena en tu .env local, no en el repositorio>"
echo "  - guard1@demo.com: <contrasena en tu .env local, no en el repositorio>"
echo "  - guard2@demo.com: <contrasena en tu .env local, no en el repositorio>"
echo ""
echo "Next steps:"
echo "1. Clear rate limit using one of the options above"
echo "2. Try logging in with: client@demo.com / <contrasena en tu .env local, no en el repositorio>"
